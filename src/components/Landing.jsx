  ...
  render() {
    return (
      <div className="">
        ...
        <div id="hero" className="text-dark">
        ...
        <main id="main">
          <div id="featured-services" className="featured-services section-bg">
          ...
          <div id="about" className="about section-bg bg-white">
            <div className="container" data-aos="fade-up">
        ...
        <ScriptTag src="../vendor/owl.carousel/owl.carousel.min.js"></ScriptTag>
        <ScriptTag src="../vendor/isotope-layout/isotope.pkgd.min.js"></ScriptTag>
        <ScriptTag src="../vendor/venobox/venobox.min.js"></ScriptTag>
